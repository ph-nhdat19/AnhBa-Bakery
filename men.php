...
// Danh mục Bánh Kem
$category_slug = 'banh-kem';  // Bạn có thể đổi slug này trong DB nếu cần
...
<head>
    ...
    <title>Bánh Kem - Anh Ba Bakery</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="main.css">
    <style>
        .category-banner {
            background: linear-gradient(rgba(107,63,42,0.75), rgba(107,63,42,0.75)), url('https://source.unsplash.com/random/1200x400/?cake') center/cover;
            color: white;
            padding: 60px 20px;
            text-align: center;
            border-radius: 16px;
        ...
        .stock-badge { font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 20px; display: inline-block; margin-bottom: 6px; }
...
<div class="main">
    ...
    <nav class="breadcrumb-nav">
        ...
        <span style="color:#333">Bánh Kem</span>
    </nav>

    <!-- Banner chuyên mục -->
    <div class="category-banner">
        <h1>Bánh Kem Ngon Nhất</h1>
        <p style="font-size:18px;opacity:0.95">Tươi ngon mỗi ngày • Trang trí đẹp mắt • Phù hợp sinh nhật & tiệc</p>
    </div>

    <div class="title">BÁNH KEM</div>
    ...
    <div class="filter-bar">
        <span class="result-count">Tìm thấy <strong><?php echo $total_products; ?></strong> loại bánh kem</span>
    ...
    <div class="product-grid">
        ...
        <div class="product">
            ...
            <form action="men.php" method="POST" onsubmit="return checkSize(this)">
