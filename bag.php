...
<head>
    ...
    <title>Bánh Lẻ & Mini - Anh Ba Bakery</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="main.css">
    <style>
        .category-banner {
            background: linear-gradient(rgba(107,63,42,0.75), rgba(107,63,42,0.75)), url('https://source.unsplash.com/random/1200x400/?cookies,macaron,pastry') center/cover;
            color: white;
            padding: 60px 20px;
            text-align: center;
            border-radius: 16px;
...
<div class="main">
    ...
    <nav class="breadcrumb-nav">
        ...
        <span style="color:#333">Bánh Lẻ & Mini</span>
    </nav>

    <!-- Banner chuyên mục -->
    <div class="category-banner">
        <h1>Bánh Lẻ & Mini</h1>
        <p style="font-size:18px;opacity:0.95">Bánh nhỏ xinh • Ăn vặt ngon miệng • Phù hợp quà tặng & tiệc trà</p>
    </div>

    <div class="title">BÁNH LẺ & MINI</div>
    ...
    <div class="filter-bar">
        <span class="result-count">Tìm thấy <strong><?php echo $total_products; ?></strong> sản phẩm bánh lẻ</span>
    ...
    <div class="product-grid">
        ...
        <div class="product">
            ...
            <form action="bag.php" method="POST" onsubmit="return checkSize(this)">
                ...
                <select name="size" class="size-select">
                    ...
                    <option value="set">Set 6 cái</option>
                    <option value="set10">Set 10 cái</option>
                </select>
...
<div class="custom-alert-overlay" id="sizeAlert">
  <div class="custom-alert-box">
    ...
    <div class="custom-alert-msg">Vui lòng chọn loại bánh<br>trước khi thêm vào giỏ hàng.</div>
